...
Full profile passed with coverage gate 79.31%; P49 smoke passed with recovery_verified_count=1, failed_verification_escalation_count=1, production_execution_count=0, and unsafe_action_count=0.
