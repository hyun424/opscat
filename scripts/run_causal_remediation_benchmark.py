#!/usr/bin/env python3
"""Run the P97 loopback-only causal remediation benchmark."""
...
from app.services.causal_remediation_benchmark import (  # noqa: E402
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.full_matrix:
        ...
        seeds = args.seeds
    payload = CausalRemediationBenchmark().run(cases=cases, seeds=seeds).to_dict()
    write_causal_remediation_outputs(payload, output_json=args.output_json, output_md=args.output_md)
