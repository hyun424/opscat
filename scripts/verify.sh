...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    -h|--help)
      cat <<'HELP'
Usage: bash scripts/verify.sh [--profile fast|full|eval|docs|p107-release|...|p134-release]
