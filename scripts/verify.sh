...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    -h|--help)
      cat <<'HELP'
Usage: bash scripts/verify.sh [--profile fast|full|eval|docs|p107-release|...|p145-release]
...
Profiles:
  ...
  p144-release
        Numeric-loopback provider adapter conformance lab, exact 64-case matrix, and final source-bound release evidence.
  p145-release
        Local response duty officer, exact 48-case preliminary matrix, and independent-review-gated final evidence.
HELP
      exit 0
      ;;
    *)
...
p141_release_profile_tests() {
  p140_release_profile_tests
  phase_release_profile p141 "${P141_RELEASE_PROFILE_TESTS[@]}"
  "${UV_DEV[@]}" python scripts/run_p141_notification_authority.py \
    --mode final \
    --profile evals/p141/input/notification-authority-profile.json \
    --canonical-matrix evals/p141/output/canonical-matrix.json \
    --freeze-manifest evals/p141/output/freeze-manifest.json \
    --final-review evals/p141/final-implementation-review.json \
    --output-dir "$VERIFY_TMPDIR/p141-release"
}
p142_release_profile_tests() {
  p141_release_profile_tests
  phase_release_profile p142 "${P142_RELEASE_PROFILE_TESTS[@]}"
  "${UV_DEV[@]}" ruff check app/p142_loopback_cli.py
  "${UV_DEV[@]}" mypy app/p142_loopback_cli.py
  "${UV_DEV[@]}" python scripts/run_p142_loopback_transport_lab.py \
    --mode final \
    --profile evals/p142/input/loopback-transport-lab-profile.json \
    --canonical-matrix evals/p142/output/canonical-matrix.json \
    --freeze-manifest evals/p142/output/freeze-manifest.json \
...
p144_release_profile_tests() {
  p143_release_profile_tests
  phase_release_profile p144 "${P144_RELEASE_PROFILE_TESTS[@]}"
  "${UV_DEV[@]}" ruff check app/p144_provider_adapter_cli.py app/services/p144_provider_adapter_lab.py app/services/p144_runner.py app/services/p144_release_evidence.py scripts/run_p144_provider_adapter_lab.py tests/fixtures/p144 tests/test_p144_provider_adapter_lab.py tests/test_p144_provider_adapter_cli.py tests/test_p144_runner.py tests/test_p144_release_evidence.py
  "${UV_DEV[@]}" mypy app/p144_provider_adapter_cli.py app/services/p144_provider_adapter_lab.py app/services/p144_runner.py app/services/p144_release_evidence.py scripts/run_p144_provider_adapter_lab.py tests/fixtures/p144 tests/test_p144_provider_adapter_lab.py tests/test_p144_provider_adapter_cli.py tests/test_p144_runner.py tests/test_p144_release_evidence.py
  "${UV_DEV[@]}" python scripts/run_p144_provider_adapter_lab.py \
    --mode final \
    --profile evals/p144/input/provider-adapter-profile.json \
    --canonical-matrix evals/p144/output/canonical-matrix.json \
    --freeze-manifest evals/p144/output/freeze-manifest.json \
    --final-review evals/p144/final-implementation-review.json \
    --output-dir "$VERIFY_TMPDIR/p144-release"
}
p145_release_profile_tests() {
  p144_release_profile_tests
  phase_release_profile p145 "${P145_RELEASE_PROFILE_TESTS[@]}"
  "${UV_DEV[@]}" ruff check app/p145_response_duty_cli.py app/services/p145_response_duty_officer.py app/services/p145_runner.py app/services/p145_release_evidence.py scripts/run_p145_response_duty_officer.py tests/fixtures/p145 tests/test_p145_response_duty_officer.py tests/test_p145_runner.py tests/test_p145_release_evidence.py
  "${UV_DEV[@]}" mypy app/p145_response_duty_cli.py app/services/p145_response_duty_officer.py app/services/p145_runner.py app/services/p145_release_evidence.py scripts/run_p145_response_duty_officer.py tests/fixtures/p145 tests/test_p145_response_duty_officer.py tests/test_p145_runner.py tests/test_p145_release_evidence.py
  "${UV_DEV[@]}" python scripts/run_p145_response_duty_officer.py \
    --mode final \
    --profile evals/p145/input/response-duty-profile.json \
    --canonical-matrix evals/p145/output/canonical-matrix.json \
    --freeze-manifest evals/p145/output/freeze-manifest.json \
    --final-review evals/p145/final-implementation-review.json \
    --output-dir "$VERIFY_TMPDIR/p145-release"
}
...
run_p141_release() { p141_release_profile_tests; }
run_p142_release() { p142_release_profile_tests; }
run_p144_release() { p144_release_profile_tests; }
run_p145_release() { p145_release_profile_tests; }
...
case "$VERIFY_PROFILE" in
  ...
  p144-release) run_p144_release ;;
  p145-release) run_p145_release ;;
  full) run_full ;;
esac
