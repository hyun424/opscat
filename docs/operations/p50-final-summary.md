...
Full profile passed with coverage gate 79.31%; P50 smoke passed with local_night_watch_ready=true, unattended_production_ready=false, production_execution_count=0, and unsafe_auto_execute_count=0.
