...
- Do not accept arbitrary request-controlled base URLs. The endpoint must come from trusted process configuration so alert or user payloads cannot redirect the agent to internal services.
